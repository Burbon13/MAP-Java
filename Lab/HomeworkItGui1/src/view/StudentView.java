...
public class StudentView {
    ...
    private void addHandler(){
        try {
            studentController.addStudent(Integer.parseInt(idStudent.getText()), nameStudent.getText(),
                    Integer.parseInt(groupStudent.getText()), emailStudent.getText(), labTeacherStudent.getText());
    ...
    private void updateHandler(){
        try {
            studentController.updateStudent(Integer.parseInt(idStudent.getText()), nameStudent.getText(),
                    Integer.parseInt(groupStudent.getText()), emailStudent.getText(), labTeacherStudent.getText());
        } catch (ServiceException | NumberFormatException e) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Student error");
    ...
    private void deleteHandler(){
        try {
            studentController.deleteStudent(Integer.parseInt(idStudent.getText()));
        } catch (ServiceException | NumberFormatException e) {
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setHeaderText("Student error");
            alert.setContentText(e.getMessage());
